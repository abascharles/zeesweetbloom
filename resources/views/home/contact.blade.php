...
<head>
    ...
    <title>Zee's Sweet Bloom | Contact</title>
...
<body class="full-wrapper">
   ...
   @include('home.header')
    <!-- header end -->
    <main>
    <div class="visme_d" data-title="Contact Us" data-url="epro9g7m-contact-us" data-domain="forms" data-full-page="false" data-min-height="700px" data-form-id="27883"></div><script src="https://static-bundles.visme.co/forms/vismeforms-embed.js"></script>
        <!--? Hero Area Start-->
